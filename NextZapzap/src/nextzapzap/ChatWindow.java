...
public class ChatWindow extends javax.swing.JFrame {
     ...
     * @param userName
     */
    public ChatWindow(LoginWindow janela) {
        initComponents();
        this.userName = janela.getUserName();
    }
    ...
    private void initComponents() {
        ...
        mensagem.setRows(3);
        mensagem.setToolTipText("Blablabla");
        mensagem.setName(""); // NOI18N
        jScrollPane2.setViewportView(mensagem);
        mensagem.getAccessibleContext().setAccessibleDescription("");
    ...
    public void enviarMensagem(String msg) throws IOException {
        bfw.write(msg + "\r\n");
        mensagem.append(userName + ": " + mensagem.getText() + "\r\n");
        bfw.flush();
        mensagem.setText("");
    }
